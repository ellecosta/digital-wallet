...
const complianceRepository = new TypeOrmComplianceTransactionRepository();

const complianceService = new ComplianceTransactionService(
  complianceRepository,
);

const complianceController = new ComplianceTransactionController(
  complianceService,
);

router.get("/", complianceController.getAll.bind(complianceController));
